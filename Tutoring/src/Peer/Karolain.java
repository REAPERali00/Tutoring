...
public class Karolain implements Starting{
	/*
	 * 1. variable: primitive, reference. created in stack
	 * 		primitive: 
	 * 			byte, short, int, long: -1, 0, 2, ... 
	 * 			float, double: 1.0, 2.23, -123.3, 3.1459123123
	 * 			char: '1', 'a', '#'
	 * 			boolean: true, false 
	 * 		Reference types: letters start with capital, hold id. (address) created in Heap. 
	 *  2. Methods: like a variable, but it holds the location of a bunch of code. 
	 *	   its best to have a method do one or two things at most. 
	 *	   to make a method, we need three parts. 
	 *	
	 *
	 */
